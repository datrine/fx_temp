...
import { ConvertCurrencyResponseBodyDTO, FundWalletOKResponseBodyDTO, GetWalletOKResponseBodyDTO, TradeCurrenciesResponseBodyDTO } from './dtos/response.dto';
...
export class WalletController {
    ...
    async tradeWithWallet(@Req() authReq: AuthRequest, @Body(new ValidationPipe({ transform: true })) bodyData: TradeCurrenciesRequestBodyDTO) {
        ...
        let dto: TradeCurrenciesResponseBodyDTO = {
            statusCode: HttpStatus.OK,
            data: resData
        }
        return dto
    ...
    async convert(@Req() authReq: AuthRequest,
        ...
        let dto: ConvertCurrencyResponseBodyDTO = {
            statusCode: HttpStatus.OK,
            data: resData
        }
        return dto
